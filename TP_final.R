...
names(set)
#Q2 
#Repr??senter un scatter plot des quatre premi??res variables
library(corrplot)
...
#............
#mod=paste("~",paste(names(df),collapse="+"))
